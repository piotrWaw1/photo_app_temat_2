...
from .models import Photo, Group, Annotation
...
class PhotoCreateAPIViewTestCase(TestCase):
    ...
    def test_create_photo(self):
        ...
        with open('./media/test_image.jpg', 'rb') as file:  
    ...
    def test_create_photo_invalid_extension(self):
        ...
        with open('./media/invalid_image.tif', 'rb') as file:  
            response = self.client.post(self.url_create, {'image': file, **data}, format='multipart')
    ...
    def test_create_photo_exceeds_size(self):
        ...
        with open('./media/oversized_image.jpg', 'rb') as file:  
            response = self.client.post(self.url_create, {'image': file, **data}, format='multipart')
...
class PhotoGetAPIViewTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='testuser', password='password123')
        self.client.force_authenticate(user=self.user)
        self.url_get = reverse('photo_detail', kwargs={'id': 1})
    ...
    def test_get_photo(self):
        ...
        response = self.client.get(reverse('photo_detail', kwargs={'id': photo.pk}))
